...
public class TestPhone {
    ...
    public static SendSmsResponse testPhoneMsg(String phoneNumbers,String signName,String templateCode,String templateParam) throws Exception {
        ...
        //替换成你的AK
        final String accessKeyId = "LTAI4FeqEGRFE3oRK9WzM47u";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "YF9oRTdBLxaJLE8FZkjE5bu8L2kS0y";//你的accessKeySecret，参考本文档步骤2
...
//        }
    ...
    public String testPhones(String phoneNumber) {
        ...
        try {
            ...
            //调用方法接收返回值
            SendSmsResponse sendSmsResponse = testPhoneMsg(phoneNumber,"小蛋黄","SMS_174685257","{\"code\":\""+random+"\"}");
    ...
    public void testPhoneUtil() {
        ...
        String message = testPhones("18811073770");
        System.out.println(message);
        }
    ...
    public void testPhoneMsg() {
        ...
        String message = PhoneMsgUtil.getPhones("18811073770",random);
        System.out.println(message);
    }
    }
